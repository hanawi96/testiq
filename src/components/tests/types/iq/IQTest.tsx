...
export default function IQTest({ questions, timeLimit, onComplete, startImmediately = false }: IQTestProps) {
  ...
  // Font Size Controls
  const [fontSizePopupPosition, setFontSizePopupPosition] = React.useState({ top: 0, left: 0 });
  
  const toggleFontSizePopup = (event?: React.MouseEvent) => {
    if (event) {
        ...
        <div className="max-w-4xl mx-auto text-center py-20 dark:bg-gray-900">
          <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-12 border border-gray-100 dark:border-gray-700">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4">
              ...
              <button 
                onClick={(e) => toggleFontSizePopup(e)}
  ...
  return (
    <div className={`relative min-h-screen w-full bg-white dark:bg-gray-900 ${isResting ? 'disable-animations' : ''}`}>
      ...
      {/* Font Size Popup - redesigned as a single row */}
      {showFontSizePopup && (
        <>
          <div 
          ...
          />
          <div 
            className="fixed z-50 bg-white dark:bg-gray-800 rounded-lg shadow-lg py-2 px-3"
            style={{ 
              top: fontSizePopupPosition.top, 
              left: fontSizePopupPosition.left 
            }}
          >
            <div className="flex items-center space-x-3">
              <button 
                onClick={decreaseFontSize}
                className="w-7 h-7 flex items-center justify-center rounded-md bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
              ...
              <div className="font-medium text-gray-700 dark:text-gray-300 text-sm min-w-[40px] text-center">
                {fontSize}%
              </div>
