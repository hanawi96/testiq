    ...
    return (
      <div className="bg-red-50 border border-red-200 rounded-lg p-8 text-center">
        ...
        >
          ...
          <h3 className="text-lg font-semibold text-red-900 mb-2">Lỗi truy cập</h3>
    ...
    <div className="space-y-8">
      ...
      >
        <div className="flex items-center justify-between mb-6">
          ...
          <span className="text-sm text-gray-500">{actions.length} chức năng</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {actions.map((action, index) => (
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="group bg-gray-50 hover:bg-gradient-to-br hover:from-blue-50 hover:to-indigo-50 border border-gray-200 hover:border-blue-200 rounded-lg p-4 transition-all duration-200"
            >
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h4 className="font-semibold text-gray-900 group-hover:text-blue-900 mb-1">
                    {action.title}
                  </h4>
